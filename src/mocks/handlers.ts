...
const mockAuditLogs: TAuditLog[] = [
  ...
  },
  {
    ...
    action: 'LOGIN',
    actor: 'jane.smith@example.com',
    timestamp: '2026-05-24T08:45:00Z',
    details: 'Berhasil melakukan login ke sistem.',
  },
  {
    id: 'LOG-005',
    ...
    details: 'Mengubah status user ID: 3 menjadi Inactive.',
  },
  {
    id: 'LOG-006',
    action: 'CREATE_USER',
  ...
  },
  {
    ...
    action: 'UPDATE_USER',
    actor: 'john.doe@example.com',
    timestamp: '2026-05-23T11:50:00Z',
    details: 'Mengubah status user ID: 2 menjadi Pending.',
  },
  {
    id: 'LOG-011',
    action: 'LOGIN',
    actor: 'chris.johnson@example.com',
